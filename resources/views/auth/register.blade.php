                    ...
                    <div class="auth-brand">
                        <div class="auth-logo">
                            <svg viewBox="0 0 40 40" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="0" y="0" width="40" height="40" rx="9.2" fill="url(#rlg)"/>
                                <rect x="1.3" y="1.3" width="37.4" height="37.4" rx="7.8" fill="none" stroke="#e8bd4f" stroke-opacity="0.35" stroke-width="0.7"/>
                                <path d="M7.9 29.7 L7.9 14.9 L13.5 14.9 L20 24.5 L26.5 14.9 L32.2 14.9 L32.2 29.7 L26.6 29.7 L26.6 22.8 L20 28.8 L13.4 22.8 L13.4 29.7 Z" fill="url(#rg)"/>
                            </svg>
                        </div>
