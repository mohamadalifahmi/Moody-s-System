...
<div class="page-header">
    <div class="page-header-content">
        ...
        <div class="page-actions">
            <a href="{{ route('reports.profit-loss', ['fromDate' => $previousFrom, 'toDate' => $previousTo]) }}" class="btn btn-outline-gold">
                <i class="fas fa-chevron-right"></i> الفترة السابقة
            </a>
            <a href="{{ route('reports.profit-loss', ['fromDate' => $nextFrom, 'toDate' => $nextTo]) }}" class="btn btn-outline-gold">
                الفترة التالية <i class="fas fa-chevron-left"></i>
            </a>
            <a href="{{ route('reports.export-profit-loss', ['from' => $fromDate, 'to' => $toDate]) }}" class="btn btn-teal">
