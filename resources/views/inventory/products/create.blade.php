...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h1><i class="fas fa-plus-circle text-gold me-2"></i> إضافة منتج جديد</h1>
            <p class="text-muted">إضافة منتج جديد إلى المخزون</p>
        </div>
        ...
        <form method="POST" action="{{ route('inventory.products.store') }}">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="اسم المنتج">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror" value="{{ old('sku') }}" placeholder="رمز المنتج">
                    @error('sku')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">الباركود</label>
                    <input type="text" name="barcode" class="form-control @error('barcode') is-invalid @enderror" value="{{ old('barcode') }}" placeholder="باركود المنتج">
                ...
                <div class="col-md-4">
                    ...
                    <select name="unit" class="form-select @error('unit') is-invalid @enderror">
                        ...
                        <option value="kg" {{ old('unit') == 'kg' ? 'selected' : '' }}>كيلو جرام</option>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="sale_price" class="form-control @error('sale_price') is-invalid @enderror" value="{{ old('sale_price') }}" placeholder="0.00">
                    </div>
                    @error('sale_price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label">الكمية <span class="text-danger">*</span></label>
                    <input type="number" step="0.01" min="0" name="stock_quantity" class="form-control @error('stock_quantity') is-invalid @enderror" value="{{ old('stock_quantity', 0) }}" placeholder="0">
